from makayla_dog import *

Dog.instantiate_from_csv("C:/Users/makay/OneDrive - University of Virginia/BME 2315/Module 1/Example_Work_For_Module1/makayla_dog_class_main.py")
...
with open("C:/Users/makay/OneDrive - University of Virginia/BME 2315/Module 1/dog data set.csv", newline="") as f:
        reader = csv.reader(f)
        headers = next(reader) # Get the first row
        for h in headers:
            print(h)

Dog.instantiate_from_csv("C:/Users/makay/OneDrive - University of Virginia/BME 2315/Module 1/dog data set.csv")
